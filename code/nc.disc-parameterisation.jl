...
begin
    fig = Figure(resolution = (1100, 300), backgroundcolor = RGBAf(0.0,0.0,0.0,0.0,))
    ...
    text!(ax1, -13, 10, text = "Thin", fontsize = LARGE_FONT_SIZE, font = :bold)
    text!(ax2, -13, 10, text = "Thick", fontsize = LARGE_FONT_SIZE, font = :bold)

    colgap!(ga, 0)

    Makie.save("presentation/figs/disc-paramterisation.svg", fig)
    fig
end
